...
const SEED = [
  {id:1,lCode:'014',sCode:'SUP100',supplierType:'Manufacturer',supplierName:'INDIA HYDRAULICS',address:'TIRUCHENGODE (TK)',city:'TIRUCHENGODE',country:'India',state:'Tamil Nadu',stateCode:'TN',pinCode:'637001',contactPerson:'RAMASAMY',mobile:'9443189164',phone:'',email:'info@indiahydraulics.net',website:'',gstNo:'',panNo:'',bankName:'',branchName:'',accountName:'',accountNumber:'',ifscCode:'',micrCode:''},
  {id:2,lCode:'015',sCode:'SUP101',supplierType:'Dealer',supplierName:'TAMILNADU STEEL & TRADING',address:'TIRUCHENGODE (TK)',city:'TIRUCHENGODE',country:'India',state:'Tamil Nadu',stateCode:'TN',pinCode:'',contactPerson:'',mobile:'',phone:'',email:'',website:'',gstNo:'',panNo:'',bankName:'',branchName:'',accountName:'',accountNumber:'',ifscCode:'',micrCode:''},
  {id:3,lCode:'',sCode:'SUP108',supplierType:'Trader',supplierName:'OPENING STOCK',address:'',city:'',country:'India',state:'Tamil Nadu',stateCode:'TN',pinCode:'',contactPerson:'',mobile:'',phone:'',email:'',website:'',gstNo:'',panNo:'',bankName:'',branchName:'',accountName:'',accountNumber:'',ifscCode:'',micrCode:''},
  {id:4,lCode:'',sCode:'SUP137',supplierType:'Distributor',supplierName:'HYDRAULICS & PNEUMATICS CO',address:'COIMBATORE',city:'COIMBATORE',country:'India',state:'Tamil Nadu',stateCode:'TN',pinCode:'',contactPerson:'SHABIR',mobile:'9894339642',phone:'',email:'',website:'',gstNo:'',panNo:'',bankName:'',branchName:'',accountName:'',accountNumber:'',ifscCode:'',micrCode:''},
  {id:5,lCode:'',sCode:'SUP138',supplierType:'Manufacturer',supplierName:'S.N. ENGINEERS',address:'BANGALORE',city:'BANGALORE',country:'India',state:'Karnataka',stateCode:'KA',pinCode:'',contactPerson:'MADHI',mobile:'9640589658',phone:'',email:'',website:'',gstNo:'',panNo:'',bankName:'',branchName:'',accountName:'',accountNumber:'',ifscCode:'',micrCode:''},
]

const emptyForm = {supplierType:'',sCode:'',supplierName:'',address:'',city:'',country:'India',state:'',stateCode:'',pinCode:'',contactPerson:'',mobile:'',phone:'',email:'',website:'',gstNo:'',panNo:'',bankName:'',branchName:'',accountName:'',accountNumber:'',ifscCode:'',micrCode:''}
    ...
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg overflow-hidden">
        <div className="bg-gradient-to-r from-[#0097A7] to-[#00BCD4] px-6 py-4 flex items-center justify-between">
          <h2 className="text-white font-bold text-[15px]">Supplier Master Details</h2>
...
export default function SupplierMaster(){
  ...
  const filtered=rows.filter(r=>[r.sCode,r.supplierName,r.city,r.state,r.contactPerson,r.mobile,r.email].some(v=>String(v).toLowerCase().includes(search.toLowerCase())))
    ...
    <div className="p-4 space-y-4 w-full min-w-0">
      ...
      <div className="bg-white rounded border border-slate-200 shadow-sm overflow-hidden">
        <div className="bg-[--color-main] px-4 py-2.5">
          <h2 className="text-white text-center font-semibold text-[14px]">{editId!==null?'Edit - Supplier Master Details':'Create - Supplier Master Details'}</h2>
        </div>
        <div className="p-4">
          ...
          <table className="min-w-full text-[13px]">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200">
                {['S.No','L.Code','S.Code','Name','City','State','Con. Person','Mobile','EMail Id','Edit','Delete','Details'].map(h=>(
                  <th key={h} className="text-center px-3 py-2.5 font-semibold text-slate-600 text-[12px] uppercase tracking-wide whitespace-nowrap">
                    {h}
                    {['L.Code','S.Code','Name','City','State','Con. Person','Mobile','EMail Id'].includes(h)&&(
