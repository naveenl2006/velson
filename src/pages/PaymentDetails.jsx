    ...
    <div className="bg-[#f4f6f8] min-h-full">
      ...
      <div className="px-6 py-6">
        ...
        <div className="flex items-center gap-2 text-[12px] text-slate-400 mb-5">
          ...
          <ChevronRight className="w-3 h-3" />
          <span className="text-[#0097A7] font-semibold">Payment Details</span>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
          ...
          <div className="flex items-center justify-between border-b border-slate-200 bg-slate-50 px-4 py-2.5">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-[13px] font-bold text-slate-700 uppercase tracking-tight">Payment Details</h2>
            </div>
            <div className="flex items-center gap-2">
              {[
          ...
          <div className="p-4">
                  ...
                  {filteredData.length === 0 ? (
                    ...
                    filteredData.map((row, idx) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 border-r border-slate-200 uppercase text-[11px] font-bold">PAYMENT</td>
            ...
            <div className="mt-4 flex items-center bg-slate-50 border border-slate-200 rounded-lg p-2 text-[12px] font-bold text-slate-600">
               ...
               <div className="px-8 border-l border-slate-200 text-right whitespace-nowrap">
                 <span className="text-slate-400 mr-2 uppercase text-[10px]">Total Payment Amount</span>
