...
export default function VoucherEntry() {
  ...
  const handleSave = () => {
    if (!form.voucherType || rows.every(r => !r.amt)) {
      alert('Please select Voucher Type and add amount.')
      return
    }
    ...
    alert('Voucher Saved to LocalStorage Successfully!')
    handleCancel()
  }
    ...
    <div className="bg-[#f4f6f8] min-h-full">
      ...
      <div className="px-6 py-6">
        <div className="flex items-center gap-2 text-[12px] text-slate-400 mb-5 uppercase font-black">
          <span>Dashboard</span> <ChevronRight size={12} /> <span>Account</span> <ChevronRight size={12} /> <span className="text-[#0097A7]">Voucher Entry</span>
        </div>
